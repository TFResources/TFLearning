...
def loss(y_conv, y_):
    cross_entropy = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(y_conv, y_, name="loss_entropy")
...
def run_training():
    ...
    with tf.Graph().as_default():
        ...
        summary_writer = tf.train.SummaryWriter("mnist_mcn_log", sess.graph)
